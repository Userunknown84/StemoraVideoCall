...
export default function VideoMeet() {
    ...
    let getUserMedia = () =>{
       if((video && videoAvailable) || (audio && audioAvailable)){
        ...
        try{
            let tracks = localVideoRef.current.src.Object.getTracks();
            tracks.forEach(track => track.stop());
        }catch(err){
                console.log(err);
        }
            ...
            socketRef.current.on("user-joined",(id,clients)=>{
                ...
                if(id === socketIdRef.current){
                    for(let id2 in connections){
                        ...
                        //  console.log("Peer:",id2,"State:",connections[id2].signalingState);
  ...
  return (
    <div className='VideoMeet'>
        ...
        <div className='Video'> 
            ...
            <TextField className='text' id="outlined-basic" label="Username"
            ...
            <div>
            <video className='videocall' ref={localVideoRef} autoPlay muted></video>
            </div>
